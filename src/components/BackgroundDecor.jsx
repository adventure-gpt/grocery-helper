export default function BackgroundDecor() {
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0" aria-hidden="true">
      {/* Carrot - top left */}
      <svg viewBox="0 0 80 120" className="absolute w-24 opacity-[0.45]" style={{ top: '5%', left: '2%', transform: 'rotate(25deg)' }}>
      ...
      {/* Apple - top right */}
      <svg viewBox="0 0 100 110" className="absolute w-20 opacity-[0.45]" style={{ top: '8%', right: '4%', transform: 'rotate(-15deg)' }}>
      ...
      {/* Lemon - mid left */}
      <svg viewBox="0 0 100 70" className="absolute w-20 opacity-[0.45]" style={{ top: '32%', left: '1%', transform: 'rotate(-30deg)' }}>
      ...
      {/* Broccoli - right side */}
      <svg viewBox="0 0 90 100" className="absolute w-22 opacity-[0.45]" style={{ top: '40%', right: '2%', transform: 'rotate(10deg)' }}>
      ...
      {/* Tomato - lower left */}
      <svg viewBox="0 0 100 100" className="absolute w-20 opacity-[0.45]" style={{ top: '62%', left: '4%', transform: 'rotate(15deg)' }}>
      ...
      {/* Avocado - lower right */}
      <svg viewBox="0 0 80 120" className="absolute w-22 opacity-[0.45]" style={{ top: '68%', right: '5%', transform: 'rotate(-20deg)' }}>
      ...
      <svg viewBox="0 0 60 110" className="absolute w-16 opacity-[0.45]" style={{ top: '15%', left: '22%', transform: 'rotate(35deg)' }}>
      ...
      {/* Pear - bottom center */}
      <svg viewBox="0 0 80 120" className="absolute w-20 opacity-[0.45]" style={{ top: '82%', left: '42%', transform: 'rotate(5deg)' }}>
      ...
      <svg viewBox="0 0 70 90" className="absolute w-16 opacity-[0.45]" style={{ top: '48%', right: '20%', transform: 'rotate(-10deg)' }}>
      ...
      {/* Banana - top center */}
      <svg viewBox="0 0 120 80" className="absolute w-24 opacity-[0.45]" style={{ top: '3%', left: '40%', transform: 'rotate(-12deg)' }}>
      ...
      <svg viewBox="0 0 80 100" className="absolute w-20 opacity-[0.42]" style={{ top: '52%', left: '15%', transform: 'rotate(8deg)' }}>
      ...
      <svg viewBox="0 0 120 70" className="absolute w-28 opacity-[0.42]" style={{ top: '88%', right: '15%', transform: 'rotate(-8deg)' }}>
      ...
      {/* Corn - right upper */}
      <svg viewBox="0 0 50 120" className="absolute w-14 opacity-[0.45]" style={{ top: '22%', right: '12%', transform: 'rotate(20deg)' }}>
      ...
      <svg viewBox="0 0 90 80" className="absolute w-18 opacity-[0.45]" style={{ top: '10%', left: '55%', transform: 'rotate(-5deg)' }}>
      ...
      {/* Eggplant - left mid */}
      <svg viewBox="0 0 50 120" className="absolute w-16 opacity-[0.42]" style={{ top: '42%', left: '8%', transform: 'rotate(-25deg)' }}>
      ...
      <svg viewBox="0 0 90 90" className="absolute w-18 opacity-[0.42]" style={{ top: '78%', left: '8%', transform: 'rotate(12deg)' }}>
      ...
      {/* Garlic - upper mid */}
      <svg viewBox="0 0 70 80" className="absolute w-16 opacity-[0.40]" style={{ top: '18%', left: '72%', transform: 'rotate(15deg)' }}>
      ...
      {/* Radish - mid right */}
      <svg viewBox="0 0 60 100" className="absolute w-14 opacity-[0.45]" style={{ top: '55%', right: '35%', transform: 'rotate(18deg)' }}>
      ...
      <svg viewBox="0 0 80 90" className="absolute w-18 opacity-[0.42]" style={{ top: '75%', left: '30%', transform: 'rotate(-8deg)' }}>
      ...
      <svg viewBox="0 0 60 50" className="absolute w-16 opacity-[0.45]" style={{ top: '25%', left: '35%', transform: 'rotate(5deg)' }}>
      ...
      <svg viewBox="0 0 40 110" className="absolute w-12 opacity-[0.45]" style={{ top: '60%', right: '10%', transform: 'rotate(-30deg)' }}>
      ...
      <svg viewBox="0 0 90 90" className="absolute w-20 opacity-[0.42]" style={{ top: '72%', right: '28%', transform: 'rotate(10deg)' }}>
      ...
      <svg viewBox="0 0 120 50" className="absolute w-24 opacity-[0.42]" style={{ top: '5%', right: '20%', transform: 'rotate(15deg)' }}>
      ...
      <svg viewBox="0 0 80 120" className="absolute w-16 opacity-[0.40]" style={{ top: '45%', left: '42%', transform: 'rotate(-40deg)' }}>
        <path d="M40 20 C38 20 30 50 28 80 C26 95 32 110 40 115 C48 110 54 95 52 80 C50 50 42 20 40 20Z" fill="#f97316" />
        <path d="M38 20 C35 10 30 2 25 0 C30 5 33 12 35 20" fill="#16a34a" stroke="none" />
        <path d="M42 20 C45 10 50 2 55 0 C50 5 47 12 45 20" fill="#16a34a" stroke="none" />
      </svg>
      ...
      <svg viewBox="0 0 60 80" className="absolute w-14 opacity-[0.40]" style={{ top: '30%', right: '40%', transform: 'rotate(45deg)' }}>
      ...
      {/* Orange - bottom left */}
      <svg viewBox="0 0 80 80" className="absolute w-18 opacity-[0.45]" style={{ top: '85%', left: '15%', transform: 'rotate(8deg)' }}>
      ...
      <svg viewBox="0 0 80 80" className="absolute w-16 opacity-[0.42]" style={{ top: '35%', right: '8%', transform: 'rotate(-15deg)' }}>
      ...
      <svg viewBox="0 0 70 130" className="absolute w-20 opacity-[0.40]" style={{ top: '58%', left: '28%', transform: 'rotate(5deg)' }}>
      ...
      <svg viewBox="0 0 70 90" className="absolute w-14 opacity-[0.45]" style={{ top: '12%', left: '12%', transform: 'rotate(20deg)' }}>
        <path d="M35 15 C20 15 5 35 5 55 C5 75 20 85 35 88 C50 85 65 75 65 55 C65 35 50 15 35 15Z" fill="#ef4444" />
        <path d="M25 12 C20 6 15 4 10 5 C16 8 22 12 28 14Z" fill="#22c55e" />
        <path d="M45 12 C50 6 55 4 60 5 C54 8 48 12 42 14Z" fill="#22c55e" />
        <circle cx="25" cy="40" r="2" fill="#fca5a5" />
      ...
      <svg viewBox="0 0 100 110" className="absolute w-16 opacity-[0.40]" style={{ top: '38%', left: '55%', transform: 'rotate(22deg)' }}>
